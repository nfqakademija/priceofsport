...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fetch_links.customer_repository' => 'getFetchLinks_CustomerRepositoryService',
            ...
            'import.link.getter' => 'getImport_Link_GetterService',
            'import.link.parser' => 'getImport_Link_ParserService',
            'import.product.data' => 'getImport_Product_DataService',
            'import.product.link' => 'getImport_Product_LinkService',
            'import_shop.customer_repository' => 'getImportShop_CustomerRepositoryService',
            'import_shoplink.customer_repository' => 'getImportShoplink_CustomerRepositoryService',
            ...
            'notification.customer_repository' => 'getNotification_CustomerRepositoryService',
            'notification.data.parser' => 'getNotification_Data_ParserService',
            'price_history.customer_repository' => 'getPriceHistory_CustomerRepositoryService',
            'product.customer_repository' => 'getProduct_CustomerRepositoryService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/FrontBundle/Entity'), 1 => ($this->targetDirs[3].'/src/ImportBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'FrontBundle\\Entity');
        $c->addDriver($b, 'ImportBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('FrontBundle' => 'FrontBundle\\Entity', 'ImportBundle' => 'ImportBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fffeb26367a17cf1c467185ee0da6bdb47cd91a178250ab8e0939761a2d6ab9a');
    ...
    /**
     * Gets the 'fetch_links.customer_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getFetchLinks_CustomerRepositoryService()
    {
        return $this->services['fetch_links.customer_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('ImportBundle:ProductPageLink');
    }
    ...
    /**
     * Gets the 'import.link.getter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ImportBundle\Services\LinkGetter A ImportBundle\Services\LinkGetter instance.
     */
    protected function getImport_Link_GetterService()
    {
        return $this->services['import.link.getter'] = new \ImportBundle\Services\LinkGetter($this->get('fetch_links.customer_repository'));
    }

    /**
     * Gets the 'import.link.parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ImportBundle\Services\LinkParser A ImportBundle\Services\LinkParser instance.
     */
    protected function getImport_Link_ParserService()
    {
        return $this->services['import.link.parser'] = new \ImportBundle\Services\LinkParser($this->get('import_shop.customer_repository'));
    }

    /**
     * Gets the 'import.product.data' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ImportBundle\Services\DataImporter A ImportBundle\Services\DataImporter instance.
     */
    protected function getImport_Product_DataService()
    {
        return $this->services['import.product.data'] = new \ImportBundle\Services\DataImporter($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'import.product.link' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ImportBundle\Services\LinkImporter A ImportBundle\Services\LinkImporter instance.
     */
    protected function getImport_Product_LinkService()
    {
        return $this->services['import.product.link'] = new \ImportBundle\Services\LinkImporter($this->get('doctrine.orm.default_entity_manager'), $this->get('import_shoplink.customer_repository'));
    }

    /**
     * Gets the 'import_shop.customer_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityRepository A Doctrine\ORM\EntityRepository instance.
     */
    protected function getImportShop_CustomerRepositoryService()
    {
        return $this->services['import_shop.customer_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('ImportBundle:Shop');
    }

    /**
     * Gets the 'import_shoplink.customer_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityRepository A Doctrine\ORM\EntityRepository instance.
     */
    protected function getImportShoplink_CustomerRepositoryService()
    {
        return $this->services['import_shoplink.customer_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('ImportBundle:ProductPageLink');
    }
    ...
    /**
     * Gets the 'notification.customer_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityRepository A Doctrine\ORM\EntityRepository instance.
     */
    protected function getNotification_CustomerRepositoryService()
    {
        return $this->services['notification.customer_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('ImportBundle:Notification');
    }

    /**
     * Gets the 'notification.data.parser' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \ImportBundle\Services\NotificationUsers A ImportBundle\Services\NotificationUsers instance.
     */
    protected function getNotification_Data_ParserService()
    {
        return $this->services['notification.data.parser'] = new \ImportBundle\Services\NotificationUsers($this->get('doctrine.orm.default_entity_manager'), $this->get('notification.customer_repository'));
    }

    /**
     * Gets the 'price_history.customer_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityRepository A Doctrine\ORM\EntityRepository instance.
     */
    protected function getPriceHistory_CustomerRepositoryService()
    {
        return $this->services['price_history.customer_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('ImportBundle:PriceHistory');
    }

    /**
     * Gets the 'product.customer_repository' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Doctrine\ORM\EntityRepository A Doctrine\ORM\EntityRepository instance.
     */
    protected function getProduct_CustomerRepositoryService()
    {
        return $this->services['product.customer_repository'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('ImportBundle:Product');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/ImportBundle/Resources/views'), 'Import');
        $instance->addPath(($this->targetDirs[3].'/src/ProcessBundle/Resources/views'), 'Process');
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57333a0b545883.63394450')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ProcessBundle' => 'ProcessBundle\\ProcessBundle',
